...
public class SwaggerConfig {
	...
	public static ApiInfo metadata() {
		...
		return new ApiInfoBuilder()
			.title("Ping-Pong")
			.description("Masaaki Yuasa's Ping-Pong Animation")
			.version("1.0.0")
			.license("Apache License Version 2.0")
			.licenseUrl("https://github.com/glaubertorres")
			.contact(contact())
			.build();
	}
	...
	private static Contact contact() {
		...
		return new Contact("Glauber Torres", 
			"https://github.com/glaubertorres", 
			"gthierrytorres@gmail.com");
